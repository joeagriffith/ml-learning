# -*- coding: utf-8 -*-
"""
Created on Sun May  1 12:49:32 2022
...
class SnekEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if self.hunger > MAX_MOVES_WITHOUT_APPLE:
            self.done = True
        ...
        self.total_reward = APPLE_REW/(2*euclidean_dist_to_apple) + apple_reward
...
class SnekEnvRendered(gym.Env):

    def __init__(self):
        super(SnekEnvRendered, self).__init__()
        # Define action and observation space
        # They must be gym.spaces objects
        # Example when using discrete actions:
        self.action_space = spaces.Discrete(4)
